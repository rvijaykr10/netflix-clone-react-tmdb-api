  ...
  useEffect(() => {
    const tmdb = async () => {
      ...
      let randomData = await axios.get(
        "https://api.themoviedb.org/3/discover/tv?api_key=YOUR_KEY&with_networks=213"
      );
